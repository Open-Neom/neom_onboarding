...
class OnBoardingDeTranslations {
  ...
  static const Map<String, String> values = {
    OnBoardingTranslationConstants.addLastProfileInfoMsg: 'Fast geschafft! Fuge die restlichen Informationen hinzu, um dein Konto abzuschliessen.',
    OnBoardingTranslationConstants.addNewProfileInfoMsg: 'Dein neues Profil ist fast fertig! Fuge die restlichen Informationen hinzu, um es zu erstellen.',
    OnBoardingTranslationConstants.addProfileImg: 'Profilbild hinzufugen',
    OnBoardingTranslationConstants.addProfileImgMsg: 'Fuge ein Profilbild hinzu, um dich der Community vorzustellen. Du kannst es spater hinzufugen.',
