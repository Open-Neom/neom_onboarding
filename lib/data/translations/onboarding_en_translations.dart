...
class OnBoardingEnTranslations {
  ...
  static const Map<String, String> values = {
    OnBoardingTranslationConstants.addLastProfileInfoMsg: 'Almost there! Add the remaining information to complete your account.',
    OnBoardingTranslationConstants.addNewProfileInfoMsg: 'Your new profile is almost ready! Add the remaining information to create it.',
    OnBoardingTranslationConstants.addProfileImg: 'Add profile image',
    OnBoardingTranslationConstants.addProfileImgMsg: 'Add a profile image to introduce yourself to the community. You can add it later.',
